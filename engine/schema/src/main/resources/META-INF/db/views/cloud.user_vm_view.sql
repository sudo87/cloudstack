...
SELECT
    ...
    `lease_action_executed`.`value` AS `lease_action_executed`
FROM
    (((((((((((((((((((((((((((((((((((`user_vm`
        ...
        LEFT JOIN `user_vm_details` `lease_action_executed` ON ((`lease_action_executed`.`vm_id` = `vm_instance`.`id`)
        AND (`lease_action_executed`.`name` = 'leaseactionexecuted'))
